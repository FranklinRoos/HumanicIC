...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 08 jul 2016 om 00:52
-- Serverversie: 5.6.24
-- PHP-versie: 5.5.24
...
INSERT INTO `functie` (`id`, `naam`, `omschrijving`) VALUES
...
(7, 'finctioneel ontwerper', 'beschrijving'),
...
(2, 'Kandidaten', 'application/modules/humanic-portal/login.php', 'header', 'y', 0, 'nl', 'usr', 2),
(3, 'Werkgevers', 'application/modules/humanic-portal/werkgever.php', 'header', 'n', 0, 'nl', 'usr', 5),
(4, 'Contact', 'http://humanicdevelopment.com/index.html#content5-12', 'header', 'y', 0, 'nl', 'usr', 8),
(5, 'Over ons', 'http://humanicdevelopment.com/index.html#content5-12', 'header', 'y', 0, 'nl', 'usr', 9),
(6, 'Kandidaat-Registratie', 'application/modules/humanic-portal/register.php', 'header', 'y', 2, 'nl', 'usr', 3),
(7, 'Algemene Voorwaarden', 'alv.php', 'footer', 'y', 0, 'nl', 'usr', 10),
(8, 'Disclaimer', 'disclaimer.php', 'footer', 'y', 0, 'nl', 'usr', 11),
(9, 'Privacy Beleid', 'privacy.php', 'footer', 'y', 0, 'nl', 'usr', 12),
(10, 'Kandidaat-Login', 'application/modules/humanic-portal/login.php', 'header', 'y', 2, 'nl', 'usr', 4),
...
(20, 'Programmeurs: F.Roos(franklin_roos@hotmail.com), T v Hout(blackhout@upcmail.nl), B.Kijlstra(bartkijlstra@gmail.com), S.Unal(selahattin@xs4all.nl), R.de Wit(r.dewit@outlook.com)', '', 'footer', 'y', 0, 'nl', 'usr', 14);
...
INSERT INTO `sociale_media` (`id`, `naam`, `link`) VALUES
(1, 'LinkedIn', ''),
(2, 'Twitter', ''),
(3, 'Facebook', '');
...
INSERT INTO `user_functie` (`id`, `user_id`, `functie_id`) VALUES
(1, 1, 5),
(2, 1, 3),
(3, 2, 1),
(4, 2, 2),
...
CREATE TABLE IF NOT EXISTS `user_sociale_media` (
  `id` int(8) NOT NULL,
  `user_id` int(5) NOT NULL,
  `sociale_media_id` int(3) NOT NULL,
...
INSERT INTO `user_sociale_media` (`id`, `user_id`, `sociale_media_id`, `sm_url`) VALUES
...
--
-- Indexen voor tabel `sociale_media`
--
...
--
-- Indexen voor tabel `user_sociale_media`
--
...
--
ALTER TABLE `nav`
  MODIFY `nav_id` int(2) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
